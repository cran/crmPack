...
## ----new_classes_kbl, echo=FALSE, results='markup'----------------------------
cn <- new_classes
...
## ----renamed_classes_kbl, echo=FALSE, results='markup'------------------------
cr <- renamed_classes
...
## ----renamed_slots_kbl, echo=FALSE, results='markup'--------------------------
cc <- class_changes
